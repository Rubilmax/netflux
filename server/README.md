...
If everything works, you should see the available routes [here](http://127.0.0.1:8000/api/spec).
...
The API description will be available [here](http://127.0.0.1:8000/api/spec).
